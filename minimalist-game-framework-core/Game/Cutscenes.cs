...
public class Scenes
	{
		...
		Engine.DrawString("> Easy", new Vector2(0,180), Color.White, h3);
		Engine.DrawString("Medium", new Vector2(0,200), Color.White, h3);
		Engine.DrawString("Hard", new Vector2(0,220), Color.White, h3);
		if (frameCount%90<=45)
		{
