    ...
    public void Update()
    {
        ...
        else
        {
            ...
            if (debugToggle)
            {
                ...
                Engine.DrawString("Pos: " + piper.loc.Rounded(2).ToString() + "Vel: " + piper.vel.Rounded(2).ToString(), new Vector2(Resolution.X - 12, 12), Color.Black, arial, TextAlignment.Right);
