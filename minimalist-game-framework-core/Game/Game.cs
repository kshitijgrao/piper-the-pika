...
class Game
{
    ...
    public Game()
    {
        level1Chunk = new Chunking("Level1Display1_18Broken.png");
        ...
        level1 = new Level("Level1Collision1_18Broken.bmp", "Assets/level1_svg.txt", level1Chunk, level1BG, new Vector2(160, 960), new Vector2(0, -838), new Vector2(2382, 420), new Vector2(0, 0), 8000, LevelPassed.none);
